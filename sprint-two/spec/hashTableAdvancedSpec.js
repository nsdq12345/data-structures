describe('hashTableAdvanced', function() {var hashTable; var people = [['Steven', 'Tyler'], ['George', 'Harrison'], ['Mr.', 'Doob'], ['Dr.', 'Sunshine'], ['John', 'Resig'], ['Brendan', 'Eich'], ['Alan', 'Turing']]; beforeEach(function() {//, ['asdasd', 'dfgfdgfdg'], ['asd', 'fjh'], ['fdgsdfghfh', '234234'], ['gsfg4', '76867fg']]; beforeEach(function() {
    hashTable = new HashTableAdvanced();
  });
/*
